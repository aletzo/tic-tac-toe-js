...
var $author$project$Main$isDraw = function (cells) {
...
var $author$project$Main$updateByKey = F2(
	function (cell, c) {
		return _Utils_eq(c.key, cell.key) ? cell : c;
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('hover', cell.hover),
						_Utils_Tuple2('played', cell.played),
						_Utils_Tuple2('win', cell.win)
					])),
				$elm$html$Html$Events$onClick(
				$author$project$Main$Play(cell)),
				$elm$html$Html$Events$onMouseOut(
				$author$project$Main$MouseOut(cell)),
				$elm$html$Html$Events$onMouseOver(
				$author$project$Main$MouseOver(cell))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(cell.text)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Main$viewCell, model.cells))
			]));
};
